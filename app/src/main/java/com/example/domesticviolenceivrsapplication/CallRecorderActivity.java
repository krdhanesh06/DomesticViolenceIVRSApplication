...
public class CallRecorderActivity extends AppCompatActivity {
    ...
    private void RequestPermissions() {
        ActivityCompat.requestPermissions(CallRecorderActivity.this, new String[]{RECORD_AUDIO, WRITE_EXTERNAL_STORAGE}, REQUEST_AUDIO_PERMISSION_CODE);
    }

    public void Back(View view) {
        Intent i = new Intent(CallRecorderActivity.this, LanguagesActivity.class);
        startActivity(i);
    }

    public void Next(View view) {
        Intent i = new Intent(CallRecorderActivity.this, DialerActivity.class);
        startActivity(i);
    }
}