...
public class CallTimerActivity extends AppCompatActivity {
   /* public int counter;
      ...
      /*  final TextView counttime = findViewById(R.id.counttime);
        ...
        new CountDownTimer(10000, 1000) {
            ...
            public void onFinish() {
                ...
                callIntent.setData(Uri.parse("tel:+917563015402"));
    ...
    public void Back(View view) {
        ...
        Intent i = new Intent(CallTimerActivity.this, ScheduledCallActivity.class);
        startActivity(i);
    }
            ...
            public void onClick(View v) {
                ...
                timer = new CountDownTimer(millisInFuture, countDownInterval) {
                    ...
                    public void onFinish() {
                        ...
                        tView.setText("Done");
                        Intent callIntent = new Intent(Intent.ACTION_CALL);
                        callIntent.setData(Uri.parse("tel:+919875487829"));
    ...
    public void Recorder(View view) {
        Intent i = new Intent(CallTimerActivity.this, CallRecorderActivity.class);
        startActivity(i);
    }
}